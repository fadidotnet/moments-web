<form id="info_form" class="form-horizontal" style="display:none;">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="phone" required class="form-control" name="phone" placeholder="Phone">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-3" >Gender:</label>
    <div class="col-sm-8">
      <select class="form-control" name="grender">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-3 col-sm-8" style="text-align:center">
      <button type="submit" id="save_info" class="btn btn-primary">Save</button>
    </div>
  </div>
</form>